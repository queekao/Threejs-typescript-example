...
const light: any = new THREE.PointLight(0xffffff, 1);
...
// this two texture filter is key point to make smooth gradient or not
...
const material: any = new THREE.MeshToonMaterial();
...
//shineness, specular and flatShading no longer supported in MeshToonMaterial
