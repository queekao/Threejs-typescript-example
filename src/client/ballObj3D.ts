...
const object1: any = new THREE.Mesh(
  new THREE.SphereGeometry(),
  new THREE.MeshPhongMaterial({color: 0xff0000})
);
object1.position.set(4, 0, 0);
scene.add(object1);
object1.add(new THREE.AxesHelper(5)); // mean parent add the Axes child
const object2: any = new THREE.Mesh(
  new THREE.SphereGeometry(),
...
const object3: any = new THREE.Mesh(
  new THREE.SphereGeometry(),
