...
//⭐️ spotLight shadow use perspectiveCamera frustum to calculate the shadow
...
//⭐️ The Directional Light Shadow uses an OrthographicCamera to calculate the shadows
...
//https://sbcode.net/threejs/spot-light-shadow/
