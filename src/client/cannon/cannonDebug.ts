...
world.broadphase = new CANNON.NaiveBroadphase(); // broadphase mean 2 obj collision
...
const torusKnotShape = CannonUtils.CreateTrimesh(torusKnotMesh.geometry); // ⭐️ Trimesh doesn't react with some specific shape
...
objLoader.load(
  ...
  (object) => {
    ...
    //     (monkeyMesh as THREE.Mesh).geometry
    // ) // this is too much calculation about the inward facing face
