...
const material = [
  // if you want material effect individually you need to use different material
...
// const somecubes = [cubes[0], cubes[2]]; // control draggable cube
// the first argument need to be array
