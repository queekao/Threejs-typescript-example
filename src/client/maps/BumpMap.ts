...
// Bump map doesn't actually affect the geometry of the object, only the lighting.
const scene = new THREE.Scene();
scene.add(new THREE.AxesHelper(5));

const light: any = new THREE.PointLight(0xffffff, 1, 100);
...
lightFolder.add(light.position, "x", -50, 50, 1);
lightFolder.add(light.position, "y", -50, 50, 1);
lightFolder.add(light.position, "z", -50, 50, 1);
